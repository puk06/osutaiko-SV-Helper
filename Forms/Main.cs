...
public partial class Main : Form
{
    ...
    private string _osuDirectory = string.Empty;
    private string _songsPath = string.Empty;
    private string _currentBeatmapPath = string.Empty;
    private bool _memoryError;
    private bool _firstLoad = true;
    private bool _readBeatmapError;
    private string _preBackgroundPath = string.Empty;
    ...
    private void UpdateMemoryData()
    {
        while (true)
        {
            try
            {
                ...
                if (osuProcesses.Length == 0) throw new Exception("osu! is not running.");
